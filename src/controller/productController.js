...
let createProduct = async function (req, res) {
    try {
        ...
        if (isFreeShipping) {
            if (!isFreeShipping) {
                return res.status(400).send({ status: false, message: "isFreeShipping is mandatory." });
            }
...
//===============router handler for get product==============
...
//===============router handler for get product by ID==============
...
//===============router handler for update products==============
...
//===============router handler for delete products===============
