...
//=================Router handler for Create User==============================
...
const getUser = async function (req, res) {
    ...
    try {
        ...
        if (!getData) {
            return res.status(404).send({ status: false, message: "User Id is not present in DataBase" });
        }
...
const updateUsers = async (req, res) => {
    try {
        ...
        if (Object.keys(data).length == 0) {
            return res.status(400).send({ status: false, message: "please provide some attribute to update..." });
        }
                ...
                if (u == "shipping" || u == "billing") {
                    if (u == "shipping" && address[u] != undefined) {
                        ...
                        for (let i = 0; i < 3; i++) {
                            ...
                            }                                          //shipping is from db , address is from body
                        }
                    }
